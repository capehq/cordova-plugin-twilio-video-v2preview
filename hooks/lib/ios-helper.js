 ...
 */
var comment = "\"Trim TwilioVideo\"";
var plugin = "cordova-plugin-twilio-video-v2preview"
var framework = "TwilioVideo.framework"
    ...
    removeShellScriptBuildPhase: function (context, xcodeProjectPath) {
        ...
        for (var buildPhaseId in buildPhases) {
            ...
            if (shouldDelete) {
				...
				console.log(comment + " build phase removed")
            }
        }
